...
ca_base <- ggplot(data = ca_df, mapping = aes(x = long, y = lat, group = group)) + coord_fixed(1.3) + geom_polygon(color = "black", fill = "gray") +theme_bw()
...
```{r}
ca_base_counties + 
  geom_point(aes(x = -119.879208, y = 34.4088777), color = "black", size = 5) + labs(x="Longitude", y="Latitude")
